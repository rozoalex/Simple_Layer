...
//In initialization, we set default_value_ and call matchSize. 
//Match size matches the size of the master grid and fills it with the value specified in default_value_, which by default is zero. 
